...
w1 = u1.workouts.create(name: 'Bench', weight: 150, reps: 3, sets: 3)
w2 = u1.workouts.create(name: 'Dips', weight:25, reps:3, sets:4)
w3 = u1.workouts.create(name: 'Dumbell Curls', weight:50, reps:3, sets:4)
w4 = u1.workouts.create(name: 'SkullCrushers', weight:70, reps:3, sets:4)
